...
const COLS =
  'id, user_id, course_code, course_name, professor, professor_email, office_hours, office_location, classroom, author, section, term, items, verified, source_url, upvotes, downvotes, imports, created_at'
