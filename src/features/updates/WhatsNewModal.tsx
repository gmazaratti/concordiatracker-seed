...
export function WhatsNewModal() {
  ...
  return (
    <ModalShell label="What's new" onClose={closeHistory} widthClass="sm:max-w-3xl" scroll={false}>
...
function ReleaseEntry({
  ...
  return (
    <>
    {/* A major release's hero spans the WHOLE width, outside the timeline
        rail: on a phone the rail's indent cost it a tenth of the screen. */}
    {release.hero && (
