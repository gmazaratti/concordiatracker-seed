      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
        <div className="mx-auto w-full max-w-2xl px-2 pb-[calc(1.5rem_+_env(safe-area-inset-bottom))]">
          {!searching ? (
            ...
            /* Everyone with a handle is searchable now, so an empty result
               means the handle is wrong -- which is worth saying, and is the
               whole message. The old second sentence explained an exclusion
