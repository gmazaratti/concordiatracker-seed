...
- RECURRING DELIVERABLES ARE NOT noDateNeeded. Weekly posts, weekly Moodle/forum activities, weekly quizzes, reading responses, journals or reflections submitted each week are real graded work with deadlines, even when the syllabus gives no single date: set due to null and noDateNeeded to false, so the student is reminded to track them.
